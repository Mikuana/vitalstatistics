...
#' the birth occured, when it is possible to report; the public data sets included
#' specific dates of birth until 1988, so accordingly all records from after that
#' point have a value of NA.
#' 
